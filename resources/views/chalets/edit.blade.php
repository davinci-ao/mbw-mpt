...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light slider-menu">
              <a class="navbar-brand" href="#">Mooiplekjetexel.nl</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="http://localhost/mbw-mpt/public/chalets">Chalets<span class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="layer">
                        <img src="{{ asset('images/slide1.jpg') }}" class="d-block w-100" alt="slide1">
                    </div>
                </div>
              </div>
