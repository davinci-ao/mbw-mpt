...
<div class="card w-25 holidaypark-card">
  <div class="card-body">
    <h5 class="card-title holidaypark-title">{{ $holidaypark->holidaypark_name }} @if (Auth::check())<a style="  padding: 5px;" href="{{ route('holidayparks.edit',$holidaypark->id)}}" ><small><i class="fas fa-edit"></i></small></a> </h5>  @endif
